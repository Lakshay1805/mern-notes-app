...
const AddEditNotes = ({noteData ,getAllNotes , type , onClose , showToastMessage}) => {
  ...
  return (
    <div className='relative'>
        <button onClick={onClose} className='w-10 h-10 rounded-full flex items-center justify-center absolute -top-3 -right-3 hover:bg-slate-300'>
